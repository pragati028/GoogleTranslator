...
set_bg = PhotoImage(file="bg.png")

label_1 = Label(window, image=set_bg)
label_1.place(x=0, y=-50)

e1 = Entry(window, bg="white", fg="black" , font=("Arial", 16, "bold"))
e1.place(x=20, y=20)
...
list_drop.configure(background="purple", foreground="white", font=('Arial', 15, "bold"))
